 ...
 */
public class VideoRotasiFragment extends Fragment implements YouTubePlayer.OnInitializedListener {
    private YouTubePlayerFragment playerView;
    public VideoRotasiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_video_rotasi, container, false);
        playerView = (YouTubePlayerFragment) getActivity().getFragmentManager().findFragmentById(R.id.video_rotasi);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
        if (!b){
            ...
            String idVidio = sharedPreferences.getString(GlobalVar.ID_VIDEO_ROT,"");
